modded class LoadingScreen {
	...
	void LoadingScreen(DayZGame game) {
		...
		m_ImageBackground.LoadImageFile(0, "WePlayDayZ/i/WePlayDayZLoading.paa");
		m_ImageBackground.LoadMaskTexture("WePlayDayZ/i/WePlayDayZLoading.paa");
...
modded class LoginQueueBase {
	...
	override Widget Init() {
		...
		imageWidgetBackground.LoadMaskTexture("WePlayDayZ/i/WePlayDayZLoading.paa");
		imageWidgetBackground.LoadImageFile(0, "WePlayDayZ/i/WePlayDayZLoading.paa");
		return w;
	}
}
